...
describe("POST /api/photos", () => {
	...
	it("7. Success 201 - Photo Created Successful (2)", async () => {
		const photo = {
			title: "ini 4d4l<>h !@#$%^&&*()",
			caption:
				"aaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaaaa",
	...
	it("9. Success 201 - Photo Created Successful (4)", async () => {
		const photo = {
			...
			poster_image_url:
				"https://ini-example.com/Lorem-ipsum-dolor-sit-amet-consectetur-adipiscing-elit-sed-do-eiusmod-tempor-incididunt/image.png"
		};
	...
	it("10. Success 201 - Photo Created Successful (5)", async () => {
		const photo = {
			...
			Elementum sagittis vitae et leo duis ut diam quam nulla. Quis imperdiet massa tincidunt nunc pulvinar sapien et ligula.`,
			poster_image_url:
				"https://ini-example.com/Lorem-ipsum-dolor-sit-amet-consectetur-adipiscing-elit-sed-do-eiusmod-tempor-incididunt-ut-labore-et-dolore-magna-aliqua-Habitant-morbi-tristique-senectus-et-netus-et-malesuada/image.png"
		};
...
describe("GET /api/photos", () => {
	...
	type CommentBody = {
		comment: string;
		User: Omit<UserBody, "id" | "profile_image_url">;
	};
	...
	it("5. Success 200 - different user get the same response", async () => {
		...
		// expect(token).toBe(anotherToken);
	...
	it("6. Success 200 - match property", async () => {
		...
		(body as ResponseBodyProperty).photos.every((photo) => {
	...
	it("7. Success 200 - match property data type (empty comments)", async () => {
		...
		(body as ResponseBodyProperty).photos.every(
			({
				id,
				title,
				caption,
	...
	it("10. Success 200 - PhotoId 2 Found (search by UserId and PhotoId)", async () => {
		const { body, statusCode } = await supertest(server)
			...
			.send({
				...
				Tincidunt arcu non sodales neque. Sapien eget mi proin sed libero enim sed faucibus.`,
				poster_image_url:
					"http://www.Non-consectetur-a-erat-nam-at-Ut-lectus-arcu-bibendum.co.id/at-varius-Tempor-commodo-ullamcorper-a-lacus-vestibulum-sed-arcu-non/image.pdf"
			});
	...
	it("11. Success 200 - PhotoId 3 Found (search by UserId and PhotoId)", async () => {
		const { body, statusCode } = await supertest(server)
			...
			.send({
				...
				poster_image_url:
					"http://www.Non-consectetur-a-erat-nam-at-Ut-lectus-arcu-bibendum.co.id/Non-consectetur-a-erat-nam-at-Ut-lectus-arcu-bibendum.co.id/at-varius-Tempor-commodo-ullamcorper-a-lacus-vestibulum-sed-arcu-non/image.pdf"
			});
