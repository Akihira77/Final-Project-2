...
import { EditCommentRequestDTO, CreateCommentRequestDTO, CommentIdParams } from "../../db/dtos/comments/index.dto.js";
...
export const updateComment = async (req, res) => {
    try {
        ...
        const existedComment = await commentService.findById(commentId, req.user.userId);
        if (!existedComment) {
            throw new CustomAPIError("Comment does not found", StatusCodes.NotFound404);
        }
        const result = await commentService.edit(req.user.userId, commentId, req.body);
